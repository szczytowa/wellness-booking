...
export default function LoginPage({ onLogin }) {
  ...
  // Wersja testowa - akceptuje tekst (nazwy apartamentów)
      ...
      <div className="bg-white p-12 md:p-16 rounded-3xl shadow-2xl text-center max-w-md w-full border-4 border-green-200">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              type="text"
              className="w-full px-6 py-5 text-xl border-4 border-green-200 rounded-2xl text-center font-bold text-green-800 bg-green-50 focus:outline-none focus:border-green-400 focus:shadow-lg transition-all placeholder:text-green-400 placeholder:font-normal placeholder:text-sm uppercase"
              value={code}
